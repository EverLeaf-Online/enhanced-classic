...
public class FootholdTree {
    ...
    // SoloMapling / GCMoveSystem: recursively flatten the quadtree so the
    // navigation graph can index every live foothold without replacing the
    // existing collision/search behavior above.

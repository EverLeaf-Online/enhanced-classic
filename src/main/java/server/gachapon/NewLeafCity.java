...
public class NewLeafCity extends GachaponItems {
    ...
    public int[] getCommonItems() {
        return new int[]{
                ...
                2040510, 2040908, 2040904, 2040907, 2040809, 2040014, 2040714, 2040712, 2044004, 2043705,
                ...
                1482010, 1482011, 1482012, 1492010, 1492011, 1492012
        };
    }

    @Override
    public int[] getUncommonItems() {
        return new int[]{2022284, 2040811, 2040815, 1102041, 1102042, 1082149};
    }

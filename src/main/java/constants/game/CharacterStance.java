...
/** MapleStory v83 character animation stance constants used by the headless QA movement engine. */
public final class CharacterStance {
    ...
    public static boolean isFacingLeft(int stance) {
        return stance == WALK_LEFT_STANCE || stance == STAND_LEFT_STANCE || stance == JUMP_LEFT_STANCE
                || stance == PRONE_LEFT_STANCE || stance == SWIM_LEFT_STANCE || stance == LADDER_LEFT_STANCE
                || stance == ROPE_LEFT_STANCE || stance == DEAD_LEFT_STANCE;
    }

    public static boolean isSwimming(int stance) { return stance == SWIM_RIGHT_STANCE || stance == SWIM_LEFT_STANCE; }
    public static boolean isStanding(int stance) { return stance == STAND_RIGHT_STANCE || stance == STAND_LEFT_STANCE; }
    public static boolean isWalking(int stance) { return stance == WALK_RIGHT_STANCE || stance == WALK_LEFT_STANCE; }
    public static boolean isJumping(int stance) { return stance == JUMP_RIGHT_STANCE || stance == JUMP_LEFT_STANCE; }
    public static boolean isProne(int stance) { return stance == PRONE_RIGHT_STANCE || stance == PRONE_LEFT_STANCE; }
    ...
    public static boolean isDead(int stance) { return stance == DEAD_RIGHT_STANCE || stance == DEAD_LEFT_STANCE; }
}

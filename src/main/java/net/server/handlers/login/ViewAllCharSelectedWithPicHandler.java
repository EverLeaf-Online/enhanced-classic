...
public class ViewAllCharSelectedWithPicHandler extends AbstractPacketHandler {
    ...
    public void handlePacket(InPacket p, Client c) {
        ...
        try {
            ...
            log.error("Unable to choose a PIC view-all channel for world={} charId={}", c.getWorld(), charId, e);
            c.sendPacket(PacketCreator.getAfterLoginError(10));
            return;
        }
        ...
        try {
            ...
            log.error("Unable to prepare PIC view-all character-select handoff for world={} channel={} charId={}",

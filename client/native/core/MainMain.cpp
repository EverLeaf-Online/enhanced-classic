...
const char* MainMain::m_sRedirectIP = "129.159.114.146";//paste your custom exp table's array into the place of v83ArrayForCustomEXP //custom exp table and level numbers MUST MATCH server numbers
...
MainMain::MainMain(std::function<void()> pPostMutexFunc)
{
	...
	Client::ServerIP_AddressFromINI = "129.159.114.146";

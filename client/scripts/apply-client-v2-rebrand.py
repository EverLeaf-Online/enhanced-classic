...
main = replace_all_required(main, "MapleEzorsiaV2wzfiles.img", "EverLeaf_UI.img", "IMG runtime filename")
...
replacements = replace_all_required(replacements, "MapleEzorsiaV2wzfiles.img/", "EverLeaf_UI.img/", "IMG namespace path")

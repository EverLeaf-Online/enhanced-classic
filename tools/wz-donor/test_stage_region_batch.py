...
def main():
    with tempfile.TemporaryDirectory() as t:
        ...
        # Real Item.wz grouped children keep an 8-digit leading zero while contracts use canonical numeric IDs.
        ...
        assert {x['contentId'] for x in report['questNodes']}=={'8163'};assert {x['contentId'] for x in report['stringNodes']}=={'4000337','800040000','9400408','9400409','9110100','8163'}

...
static WzImageProperty? ResolveModernCanvasLink(WzCanvasProperty canvas)
{
    ...
    if (!string.IsNullOrWhiteSpace(inlink))
    {
        ...
        return image.GetFromPath(inlink.Trim('/')) as WzImageProperty;
    }

...
def main() -> None:
    ...
    require(".github/workflows/run-build.yml", "Stage pinned SoloMapling GCMove system for compatibility compile", "full pinned GCMove compatibility compile enabled")
